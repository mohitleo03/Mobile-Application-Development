...
class rows extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        child: Row(
          mainAxisAlignment:MainAxisAlignment.center, //by default it is from start
          crossAxisAlignment: CrossAxisAlignment.end,
          //textBaseline: TextBaseline.alphabetic,  //ideographic for multi languages having different symbols
